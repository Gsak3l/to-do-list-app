...
//SVG for the remove and complete icons
...
//If there is some kind of text inside, add that to the todo list
...
//we have to convert the object to text usintg json
//because localstorage supports only text
...
function addItemTodo(text, completed)
{
    ...
    //add click event for adding an item
...
function completeItem()
{
    ...
    {
        //it's a completed item to be undone
